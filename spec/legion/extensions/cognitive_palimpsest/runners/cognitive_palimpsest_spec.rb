...
RSpec.describe Legion::Extensions::CognitivePalimpsest::Runners::CognitivePalimpsest do
  let(:engine) { Legion::Extensions::CognitivePalimpsest::Helpers::PalimpsestEngine.new }
  let(:runner) do
    obj = Object.new
